                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="m-l-5 font-medium d-none d-sm-inline-block"> {{ Auth::user()->nom }} <i class="mdi mdi-chevron-down"></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                ...
                                <div class="m-l-10">
                                    <h4 class="m-b-0"> {{ Auth::user()->nom }} </h4>
...
{{--                    </li>--}}
                    <li class="sidebar-item">
                            ...
                            <span class="hide-menu">IT-University</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ url('/admin/login') }}" class="sidebar-link">
                            <i class="fas fa-th-list"></i>
                            <span class="hide-menu">Admin</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ url('/cli/login') }}" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ url('/insertNote') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Insertion note</span>
                        </a>
                    </li>
                    

                    <li class="sidebar-item">
                        <a href="{{ url('/liste_etudiant') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                    ...
                    <li class="sidebar-item">
                        <a href="{{ url('/total_credit/etudiant') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                    ...
                    <li class="sidebar-item">
                        <a href="{{ url('/admin/reset') }}" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ url('/admin/import/data') }}" class="sidebar-link">
