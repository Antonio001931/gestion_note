                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            @php
                            $pr = \Illuminate\Support\Facades\Auth::guard('proprietaire')->user();
                           @endphp
                            <span class="m-l-5 font-medium d-none d-sm-inline-block">{{ $pr->telephone }}<i class="mdi mdi-chevron-down"></i></span>
                        </a>
...
{{--                    </li>--}}
                    <li class="sidebar-item">
                            ...
                            <span class="hide-menu">Mada-Immo</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ url('/pro/login') }}" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ url('/prop/liste_bien') }}" class="sidebar-link">
                            <i class="mdi mdi-file-import"></i>
                            <span class="hide-menu">Listes des biens</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ url('/prop/chiffre') }}" class="sidebar-link">
                            <i class="mdi mdi-file-import"></i>
